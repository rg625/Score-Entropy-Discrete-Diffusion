...
def get_dataset(name, mode, cache_dir=None, block_size=1024, num_proc=8):
    ...
    # --- TOKENIZER SELECTION ---
    # Check for custom tokenizer generated by train_tokenizer.py
    # Structure: ./datasets/text8/tokenizer_bpe_16k.json
    custom_tok_path = os.path.join("datasets", name, "tokenizer_bpe_16k.json")
    ...
    if os.path.exists(custom_tok_path):
        ...
        # Manually set special tokens to ensure properties like .eos_token work
        tokenizer.pad_token = "[PAD]"
        tokenizer.eos_token = "[EOS]"
        tokenizer.unk_token = "[UNK]"
    else:
        print(f"No custom tokenizer found at {custom_tok_path}. Using GPT2 default.")
        tokenizer = GPT2TokenizerFast.from_pretrained('gpt2')

    # Ensure EOS is retrieved correctly
